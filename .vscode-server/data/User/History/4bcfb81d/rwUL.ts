...
@Component({
  ...
  `,
  // Marque le composant comme standalone et indique à Angular d'importer le module jqxChartModule
  standalone: true,
...
export class PieChartComponent {
  ...
  handleChartClick(event: JqxChartEvent): void {
    // Cache le tooltip immédiatement (en passant 0 comme délai)
    if (this.chart) {
      this.chart.hideToolTip(0);
    }
    // Émet l'événement pour le composant parent
