...
// Interfaces pour typer l'événement jqxChart
      ...
      seriesGroups: [
        {
          ...
          showToolTips: true,
          labelFormat: 'custom',
          // La fonction de formatage renvoie uniquement le nom du pays.
          formatFunction: (value: number, itemIndex: number): string => {
            return this.chartData[itemIndex].country;
          },
          // La fonction de formatage du tooltip renvoie le nom et le nombre de médailles.
          toolTipFormatFunction: (value: number, itemIndex: number): string => {
