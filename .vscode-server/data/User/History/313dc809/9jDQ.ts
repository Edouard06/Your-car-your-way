...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  public pieChartSettings: any; // Si possible, utilisez une interface plus spécifique pour la config du chart
      ...
      seriesGroups: [
        {
          ...
          showLabels: true,
          showToolTips: true,
          labelFormat: 'custom', // On force le format personnalisé
          formatFunction: (value: any, itemIndex: number): string => {
            // Affiche uniquement le nom du pays sur la tranche
          ...
          toolTipFormatFunction: (
            ...
            // Au survol, affiche "Nom du pays : X médailles"
            return `${this.chartData[itemIndex].country}: ${value} médailles`;
          },
          series: [
            {
              dataField: 'medals',
              // Suppression de displayText pour éviter l'affichage par défaut du nombre
              labelRadius: 120,
              initialAngle: 15,
              radius: 120,
              centerOffset: 0
