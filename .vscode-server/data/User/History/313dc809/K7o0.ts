          ...
          seriesGroups: [
            {
              ...
              series: [
                {
                  dataField: 'medals',
                  displayText: 'country', // Affiche par défaut le nom du pays
                  labelRadius: 120,
                  initialAngle: 15,
                  radius: 120,
                  centerOffset: 0,
                   // Formate le label affiché sur la tranche (seulement le nom du pays)
          labelFormatFunction: (value: any, itemIndex: number, series: any, group: any) => {
            return this.chartData[itemIndex].country;
          },
                  // Cette fonction formate le tooltip pour afficher le nombre total de médailles
