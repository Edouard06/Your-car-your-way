          ...
          seriesGroups: [
            {
              ...
              showLabels: true,
              showToolTips: true,
              // Force l'usage d'une fonction personnalisée pour le label
              labelFormat: 'custom',
              // labelFormatFunction pour n'afficher que le nom du pays sur la tranche
              ...
              series: [
                {
                  ...
                  radius: 120,
                  centerOffset: 0,
                  // toolTipFormatFunction pour afficher "NomDuPays : X médailles" au survol
